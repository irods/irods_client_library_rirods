...
# add user alice
rirods:::iadmin(action = "add", target = "user", arg2 = "alice", arg3 = "rodsuser")

# modify alice's password
rirods:::iadmin(action = "modify", target = "user", arg2 = "alice", arg3 = "password", arg4  = "passWORD")
```
...
```{r rmAlice, include=FALSE}
# authenticate
iauth("rods", "rods")

# remove user alice
rirods:::iadmin(action = "remove", target = "user", arg2 = "alice")

# check if Alice is removed
ils()
```
