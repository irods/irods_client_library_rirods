structure(list(method = "GET", url = "/query?op=execute_genquery&query=SELECT%20COLL_NAME%2C%20DATA_NAME%2C%20DATA_SIZE%2C%20COLL_CREATE_TIME%20WHERE%20COLL_NAME%20LIKE%20%27%2FtempZone%2Fhome%2Frods%2F%25%27&offset=0&count=15&case-sensitive=1&distinct=1&parser=genquery1&sql-only=0&zone=tempZone", 
    status_code = 200L, headers = structure(list(Server = "irods_http_api/0.1.0 [86bad75c3dc6e8f8855a5978bfa43c79f069101c]", 
        `Content-Type` = "application/json", `Content-Length` = "109", 
        Date = ""), class = "httr2_headers"), body = charToRaw("{\"irods_response\":{\"status_code\":0},\"rows\":[[\"/tempZone/home/rods/testthat\",\"dfr.csv\",\"2000\",\"01706253065\"]]}"), 
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/query?op=execute_genquery&query=SELECT%20COLL_NAME%2C%20DATA_NAME%2C%20DATA_SIZE%2C%20COLL_CREATE_TIME%20WHERE%20COLL_NAME%20LIKE%20%27%2FtempZone%2Fhome%2Frods%2F%25%27&offset=0&count=15&case-sensitive=1&distinct=1&parser=genquery1&sql-only=0&zone=tempZone", 
