structure(list(method = "POST", url = "/users-groups", status_code = 200L, 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/users-groups", 
        method = "POST", headers = structure(list(Authorization = ""), redact = "Authorization"), 
        body = list(data = list(op = structure("set_password", class = "AsIs"), 
            name = structure("name", class = "AsIs"), zone = structure("tempZone", class = "AsIs"), 
            `user-type` = structure("rodsadmin", class = "AsIs"), 
            `new-password` = structure("pass", class = "AsIs")), 
