structure(list(method = "GET", url = "/collections?op=list&lpath=%2FtempZone%2Fhome%2Frods&recurse=1", 
    status_code = 200L, headers = structure(list(Server = "irods_http_api/0.1.0 [86bad75c3dc6e8f8855a5978bfa43c79f069101c]", 
        `Content-Type` = "application/json", `Content-Length` = "224", 
        Date = ""), class = "httr2_headers"), body = charToRaw("{\"entries\":[\"/tempZone/home/rods/new_collection\",\"/tempZone/home/rods/projectx\",\"/tempZone/home/rods/some_collection\",\"/tempZone/home/rods/testthat\",\"/tempZone/home/rods/testthat/dfr.csv\"],\"irods_response\":{\"status_code\":0}}"), 
