structure(list(method = "DELETE", url = "http://localhost/irods-rest/0.9.3/logicalpath?logical-path=%2FtempZone%2Fhome%2Ffoo.csv&no-trash=0&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Thu, 27 Oct 2022 17:39:24 GMT", `Content-Length` = "0", 
