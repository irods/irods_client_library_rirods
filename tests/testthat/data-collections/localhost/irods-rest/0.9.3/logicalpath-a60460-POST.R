structure(list(method = "POST", url = "http://localhost/irods-rest/0.9.3/logicalpath?logical-path=%2FtempZone%2Fhome%2Fx%2Fa&collection=1&create-parent-collections=1", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Thu, 27 Oct 2022 17:39:23 GMT", `Content-Length` = "0", 
