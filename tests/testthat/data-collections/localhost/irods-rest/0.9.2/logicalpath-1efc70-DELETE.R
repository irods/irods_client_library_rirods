structure(list(method = "DELETE", url = "http://localhost/irods-rest/0.9.2/logicalpath?logical-path=%2FtempZone%2Fhome%2Ffoo.csv&no-trash=0&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Tue, 25 Oct 2022 15:29:58 GMT", `Content-Length` = "0", 
