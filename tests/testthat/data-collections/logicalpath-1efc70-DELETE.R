structure(list(method = "DELETE", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Ffoo.csv&no-trash=0&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Sun, 30 Oct 2022 12:59:16 GMT", `Content-Length` = "0", 
