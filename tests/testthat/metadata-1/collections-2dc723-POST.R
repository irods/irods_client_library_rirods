structure(list(method = "POST", url = "/collections", status_code = 200L, 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.2.0/collections", 
        ...
        body = list(data = list(op = structure("modify_metadata", class = "AsIs"), 
            lpath = structure("%2FtempZone%2Fhome%2Frods%2Ftestthat", class = "AsIs"), 
            operations = structure("%5B%7B%22operation%22%3A%22add%22%2C%22attribute%22%3A%22foo%22%2C%22value%22%3A%22bar%22%2C%22units%22%3A%22baz%22%7D%5D", class = "AsIs"), 
