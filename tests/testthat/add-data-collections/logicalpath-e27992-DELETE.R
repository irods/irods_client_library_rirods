structure(list(method = "DELETE", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fx%2Fa&no-trash=0&recursive=1", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Tue, 24 Jan 2023 12:48:03 GMT", `Content-Length` = "0", 
