structure(list(method = "POST", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Fx%2Fa&collection=1&create-parent-collections=1", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Wed, 02 Nov 2022 12:17:59 GMT", `Content-Length` = "0", 
