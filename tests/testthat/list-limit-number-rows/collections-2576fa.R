structure(list(method = "GET", url = "/collections?op=list&lpath=%2FtempZone%2Fhome%2Frods&recurse=0", 
    status_code = 200L, headers = structure(list(Server = "irods_http_api/0.2.0 (8da6c5794f04edab1290e429a0d1676e4452dd5c)", 
        `Content-Type` = "application/json", `Content-Length` = "110", 
        Date = ""), class = "httr2_headers"), body = charToRaw("{\"entries\":[\"/tempZone/home/rods/projectx\",\"/tempZone/home/rods/testthat\"],\"irods_response\":{\"status_code\":0}}"), 
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.2.0/collections?op=list&lpath=%2FtempZone%2Fhome%2Frods&recurse=0", 
