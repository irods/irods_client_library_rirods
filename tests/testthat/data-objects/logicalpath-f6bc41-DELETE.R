structure(list(method = "DELETE", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Ffoo.csv&no-trash=1&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Wed, 02 Nov 2022 12:18:01 GMT", `Content-Length` = "0", 
