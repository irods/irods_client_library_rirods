structure(list(method = "GET", url = "/collections?op=stat&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fa", 
    status_code = 200L, headers = structure(list(Server = "irods_http_api/0.1.0 [86bad75c3dc6e8f8855a5978bfa43c79f069101c]", 
        ...
        Date = ""), class = "httr2_headers"), body = charToRaw("{\"inheritance_enabled\":false,\"irods_response\":{\"status_code\":0},\"modified_at\":1706253066,\"permissions\":[{\"name\":\"rods\",\"perm\":\"own\",\"type\":\"rodsadmin\",\"zone\":\"tempZone\"}],\"registered\":true,\"type\":\"collection\"}"), 
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/collections?op=stat&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fa", 
