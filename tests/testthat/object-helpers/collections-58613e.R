structure(list(method = "GET", url = "/collections?op=stat&lpath=%2FtempZone%2Fhome%2Frods", 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/collections?op=stat&lpath=%2FtempZone%2Fhome%2Frods", 
