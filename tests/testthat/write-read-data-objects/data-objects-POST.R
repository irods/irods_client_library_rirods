structure(list(method = "POST", url = "/data-objects", status_code = 200L, 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/data-objects", 
        ...
        body = list(data = list(op = "write", lpath = "/tempZone/home/rods/testthat/dfr.csv", 
            offset = "0", count = "24", truncate = "1", append = "0", 
            bytes = structure(list(value = as.raw(c(0x61, 0x2c, 
            0x62, 0x2c, 0x63, 0x0a, 0x61, 0x2c, 0x31, 0x2c, 0x36, 
            0x0a, 0x62, 0x2c, 0x32, 0x2c, 0x37, 0x0a, 0x63, 0x2c, 
            0x33, 0x2c, 0x38, 0x0a)), type = "application/octet-stream"), class = "form_data")), 
