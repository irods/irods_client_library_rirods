structure(list(method = "GET", url = "/data-objects?op=read&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fdfr.csv&offset=0&count=8192", 
    status_code = 200L, headers = structure(list(Server = "irods_http_api/0.1.0 [86bad75c3dc6e8f8855a5978bfa43c79f069101c]", 
        ...
        Date = ""), class = "httr2_headers"), body = structure(find_mock_file("/data-objects-ed87ca.R-FILE"), 
        class = "httr2_path"), request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/data-objects?op=read&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fdfr.csv&offset=0&count=8192", 
