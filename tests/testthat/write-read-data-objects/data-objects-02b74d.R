structure(list(method = "GET", url = "/data-objects?op=read&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fdfr.rds", 
    status_code = 200L, headers = structure(list(Server = "irods_http_api/0.2.0 (8da6c5794f04edab1290e429a0d1676e4452dd5c)", 
        `Content-Type` = "application/json", `Content-Length` = "401", 
        Date = ""), class = "httr2_headers"), body = charToRaw("X\n"), 
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.2.0/data-objects?op=read&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fdfr.rds", 
