structure(list(method = "POST", url = "/data-objects", status_code = 200L, 
    headers = structure(list(Server = "irods_http_api/0.1.0 [86bad75c3dc6e8f8855a5978bfa43c79f069101c]", 
        ...
        Date = ""), class = "httr2_headers"), body = charToRaw("{\"irods_response\":{\"status_code\":0},\"parallel_write_handle\":\"a570f900-5690-49f7-8202-6e595870a3c9\"}"), 
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/data-objects", 
        ...
        body = list(data = list(op = structure("parallel_write_init", class = "AsIs"), 
            lpath = structure("%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fx", class = "AsIs"), 
            `stream-count` = structure("2", class = "AsIs"), 
            truncate = structure("1", class = "AsIs"), append = structure("0", class = "AsIs")), 
