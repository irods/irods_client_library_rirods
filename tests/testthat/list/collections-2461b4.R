structure(list(method = "GET", url = "/collections?op=list&lpath=%2FtempZone%2Fhome%2Frods%2FtempZone%2Fhome%2Frods%2Fprojectx&recurse=0", 
    status_code = 400L, headers = structure(list(Server = "irods_http_api/0.1.0 [86bad75c3dc6e8f8855a5978bfa43c79f069101c]", 
        `Content-Type` = "application/json", `Content-Length` = "42", 
        Date = ""), class = "httr2_headers"), body = charToRaw("{\"irods_response\":{\"status_code\":-170000}}"), 
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/collections?op=list&lpath=%2FtempZone%2Fhome%2Frods%2FtempZone%2Fhome%2Frods%2Fprojectx&recurse=0", 
