structure(list(method = "GET", url = "/collections?op=list&lpath=%2Fprojectx&recurse=0", 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/collections?op=list&lpath=%2Fprojectx&recurse=0", 
