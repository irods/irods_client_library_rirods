structure(list(method = "GET", url = "/data-objects?op=stat&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fqux.rds", 
    status_code = 200L, headers = structure(list(Server = "irods_http_api/0.2.0 (8da6c5794f04edab1290e429a0d1676e4452dd5c)", 
        ...
        Date = ""), class = "httr2_headers"), body = charToRaw("{\"checksum\":\"\",\"irods_response\":{\"status_code\":0},\"modified_at\":\"\",\"permissions\":[{\"name\":\"rods\",\"perm\":\"own\",\"type\":\"rodsadmin\",\"zone\":\"tempZone\"}],\"registered\":true,\"size\":238,\"type\":\"data_object\"}"), 
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.2.0/data-objects?op=stat&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fqux.rds", 
