structure(list(method = "POST", url = "/data-objects", status_code = 200L, 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/data-objects", 
        ...
        body = list(data = list(op = "write", lpath = "/tempZone/home/rods/testthat/some_object.rds", 
            offset = "0", count = "133", truncate = "1", append = "0", 
            bytes = structure(list(value = as.raw(c()), type = "application/octet-stream"), class = "form_data")), 
