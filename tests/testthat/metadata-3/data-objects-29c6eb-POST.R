structure(list(method = "POST", url = "/data-objects", status_code = 200L, 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.2.0/data-objects", 
        ...
        body = list(data = list(op = structure("remove", class = "AsIs"), 
            recurse = structure("1", class = "AsIs"), lpath = structure("%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fsome_object.rds", class = "AsIs"), 
            `no-trash` = structure("1", class = "AsIs"), `catalog-only` = structure("0", class = "AsIs")), 
