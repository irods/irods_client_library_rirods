structure(list(method = "GET", url = "/data-objects?op=stat&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Ffoo.csv", 
    status_code = 200L, headers = structure(list(Server = "irods_http_api/0.1.0 [86bad75c3dc6e8f8855a5978bfa43c79f069101c]", 
        ...
        Date = ""), class = "httr2_headers"), body = charToRaw("{\"checksum\":\"\",\"irods_response\":{\"status_code\":0},\"modified_at\":1706253076,\"permissions\":[{\"name\":\"rods\",\"perm\":\"own\",\"type\":\"rodsadmin\",\"zone\":\"tempZone\"}],\"registered\":true,\"size\":2000,\"type\":\"data_object\"}"), 
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/data-objects?op=stat&lpath=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Ffoo.csv", 
