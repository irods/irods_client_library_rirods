structure(list(method = "POST", url = "/data-objects", status_code = 200L, 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/data-objects", 
        ...
        body = list(data = list(op = structure("rename", class = "AsIs"), 
            `old-lpath` = structure("%2FtempZone%2Fhome%2Frods%2Ftestthat%2Ffoo.csv", class = "AsIs"), 
            `new-lpath` = structure("%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fbar.csv", class = "AsIs")), 
