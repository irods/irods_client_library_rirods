structure(list(method = "POST", url = "/data-objects", status_code = 200L, 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/data-objects", 
        ...
        body = list(data = list(op = "write", lpath = "/tempZone/home/rods/testthat/foo.csv", 
            offset = "0", count = "2000", truncate = "1", bytes = structure(list(
                value = as.raw(c(0x58, 0x0a, 0x00, 0x00, 0x00, 
                0x03, 0x00, 0x04, 0x03, 0x02, 0x00, 0x03, 0x05, 
                0x00, 0x00, 0x00, 0x00, 0x05, 0x55, 0x54, 0x46, 
                0x2d, 0x38, 0x00, 0x00, 0x00, 0x0e, 0x00, 0x00, 
                0x00, 0x01, 0x3f, 0xf0, 0x00, 0x00, 0x00, 0x00, 
                0x00, 0x00)), type = "application/octet-stream"), class = "form_data")), 
