structure(list(method = "POST", url = "/data-objects", status_code = 200L, 
    ...
    request = structure(list(url = "http://localhost:9001/irods-http-api/0.1.0/data-objects", 
        ...
        body = list(data = list(op = "write", lpath = "/tempZone/home/rods/testthat/x", 
            offset = "0", count = "150", truncate = "1", append = "0", 
            ...
            0x46, 0x2d, 0x38, 0x00, 0x00, 0x00, 0x13, 0x00, 0x00, 
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x00)), type = "application/octet-stream"), class = "form_data")), 
