...
[`vignette("demo")`](https://irods.github.io/irods_client_library_rirods/articles/demo.md).)
...
session to an iRODS collection. For this, use the
...
For more on using metadata, check out
...
current R session, she would use
