...
# get file
curl -X GET -H "Authorization: ${TOKEN}" -H "Accept-Encoding: gzip, deflate, br" 'http://localhost//irods-rest/0.9.3/stream?logical-path=%2FtempZone%2Fhome%2Frods%2Ffoo&offset=0&count=1000' -v > foo.bin
